...
use crate::models::{HttpResponse, SavedRequest};
use crate::store::{load_store, now_ms, save_store};

#[tauri::command]
pub async fn list_requests(app: tauri::AppHandle) -> Result<Vec<SavedRequest>, String> {
...
#[tauri::command]
pub async fn delete_request(app: tauri::AppHandle, id: String) -> Result<bool, String> {
    let mut store = load_store(&app)?;
